...
在本教程中，我们将介绍如何在使用 IFLeaner 在 MNIST 数据集下结合 SMPC 完成图像分类联邦训练。
...
```
恭喜您！您已成功构建并运行了您的第一个联邦学习系统。完整的该示例的源代码参考[Quickstart_SMPC](https://github.com/iflytek/iflearner/tree/main/examples/homo/quickstart_smpc)。